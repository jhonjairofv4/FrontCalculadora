...
function generarDatos(datostoshow){
  ...
  const tasaEAIngresada = []
  const resultadoEAaNMV = []
  ...
  document.getElementById("formularioDos").addEventListener("submit", function(e)
  
    {
        ...
        tasaEAIngresada.push(valorTasados)
        localStorage.setItem("historialEAIngresada",tasaEAIngresada)
        ...
        resultadoEAaNMV.push(Math.round(Convierteefectivaanualanominalmes.efectivaAnualAnominalMensual()*1000)/1000)
        localStorage.setItem("historialresultadoEAaNMV",resultadoEAaNMV)
